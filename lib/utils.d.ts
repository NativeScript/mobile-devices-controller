...
export declare const basicPredicateFilter: (searchQuery: any, device: any, prop: any) => boolean;
...
export declare function attachToProcess(processToWatchLog: any, matcher: any, timeOut: any): Promise<unknown>;
export declare function waitForResult(childProcess: any, matcher: any, timeout: any): Promise<string>;
export declare const wait: (milliseconds: any) => boolean;
